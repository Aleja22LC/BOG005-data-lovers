...
describe(filtrarGenero, () => {
  it('Deberia mostrar atletas femeninos', () => {
    const dataFemenino = [
      {
        "name": "Chantal Achterberg",
        "gender": "F",
    ...
    expect(filtrarGenero("F", muestraGenero)).toEqual(dataFemenino);
  });

  it('Deberia mostrar atletas masculinos', () => {
    const dataMasculino = [ 
      {
        "name": "Denis Mikhaylovich Ablyazin",
        "gender": "M",
    ...
    expect(filtrarGenero("M", muestraGenero)).toEqual(dataMasculino);
  });
